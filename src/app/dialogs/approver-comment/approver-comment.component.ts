...
@Component({
  selector: 'app-approver-comment',
  templateUrl: './approver-comment.component.html',
  styleUrls: ['./approver-comment.component.scss']
})
export class ApproverCommentComponent {

  constructor(public dialogRef: MatDialogRef<ApproverCommentComponent>,
    ...
    stopEdit(): void {
      this.dataService.updateApproverComment(this.data);
    }
}
